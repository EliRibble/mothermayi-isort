...
DATA_ROOTS = []
PROJECT = 'mmiisort'
VERSION_FILE = 'mmiisort/__init__.py'
...
def main():
    setup(
        name                 = "mothermayi-isort",
        version              = get_version(),
        description          = "The isort plugin for mothermayi",
        url                  = "https://github.com/EliRibble/mothermayi-isort",
